...
export class WebhookService {
  constructor({ store, orgId, whatsappAdapter, channelManager, channelAccounts, contacts, conversations, messages, domain, assignment, media, ai, notifications, legacyDualWrite, allowUnsigned = false }) {
    this.store = store;
    this.orgId = orgId;
