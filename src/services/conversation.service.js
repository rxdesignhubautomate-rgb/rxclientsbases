...
import { preferenceCollection, preferenceId } from "./inbox-access.js";
...
export class ConversationService {
  ...
  async list(orgId, options = {}) {
    ...
    if (options.to) filters.push(["updatedAt", "<=", options.to]);
    const fetchLimit = options.limit; // Cursor must advance only over the page actually returned/scanned.
